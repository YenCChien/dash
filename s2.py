...
def get_logo():
    logo = html.Div([
        ...
        html.Div([
            html.Img(src='http://172.25.1.111/ProductEngineering/Product/AM/CODA/CODA-4514/Code/hitron-brand-signature.png', height='70', width='160')
